...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Vivoinnovaonexgobyte network</numerusform>
            <numerusform>%n active connections to Vivoinnovaonexgobyte network</numerusform>
        </translation>
    </message>
