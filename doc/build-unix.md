...
Note
---------------------
Always use absolute paths to configure and compile vivoinnovaonexgobyte and the dependencies,
...
Security
--------
To help make your Vivoinnovaonexgobyte installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, vivoinnovaonexgobyte should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, vivoinnovaonexgobyte may be compiled in
