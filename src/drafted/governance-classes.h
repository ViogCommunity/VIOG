 ...
 *
 *   // network
 *   CViogNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CViogNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ViogNetwork
// //   -- signature requirements : Key1(User)
// class CViogNetworkVariable : public CGovernanceObject
// {
// private:
