...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:9910", "127.0.0.1", 9910));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9910", "127.0.0.1", 9910));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9910", "::ffff:127.0.0.1", 9910));
    BOOST_CHECK(TestSplitHost("[::]:9999", "::", 9910));
    BOOST_CHECK(TestSplitHost("::9910", "::9910", -1));
    BOOST_CHECK(TestSplitHost(":9910", "", 9910));
    BOOST_CHECK(TestSplitHost("[]:9910", "", 9910));
