    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("VIOG-light"), QVariant("light"));
    ui->theme->addItem(QString("VIOG-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("VIOG-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("VIOG-traditional"), QVariant("trad"));
