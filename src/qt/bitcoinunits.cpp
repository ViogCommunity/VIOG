...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(VIOG);
    unitlist.append(mVIOG);
    unitlist.append(uVIOG);
...
QString BitcoinUnits::name(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            ...
            case mVIOG: return QString("mVIOG");
            case uVIOG: return QString::fromUtf8("μVIOG");
    ...
    else
    {
        switch(unit)
        {
            case VIOG: return QString("tVIOG");
            case mVIOG: return QString("mtVIOG");
            case uVIOG: return QString::fromUtf8("μtVIOG");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case VIOG:  return 100000000;
    case mVIOG: return 100000;
    case uVIOG: return 100;
    case duffs: return 1;
